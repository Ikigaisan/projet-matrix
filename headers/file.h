 ...
 * 
 * Remarque : cette fonction n'est là que pour vous aider à vérifier que votre résultat est correct, mais vous ne devez pas l'implémenter (sauf si vous le désirez :))
 */
 ...
 * @param FILE*  un pointeur vers un fichier ouvert dans lequel il faut écrire le double
 * 
 ...
 * 
 * @return vector* un pointeur vers un vecteur ayant pour contenu le vecteur représenté dans le fichier
 */
 ...
 * @param FILE*   un pointeur vers un fichier ouvert dans lequel il faut écrire le contenu du vecteur
 * 
 ...
 * 
 * @return matrix* un pointeur vers une matrice ayant pour contenu la matrice représentée dans le fichier
 */
 ...
 * @param FILE* un pointeur vers un fichier ouvert dans lequel il faut écrire le contenu de la matrice
 * 
 ...
 * 
 * @param FILE*   un pointeur vers un fichier ouvert contenant la décomposition QR
 ...
 * 
 * @result les matrices Q et R ont été lues et mises dans les matrices correspondantes
 * 
 * Remarque : cette fonction n'est là que pour vous aider à vérifier que votre résultat est correct, mais vous ne devez pas l'implémenter (sauf si vous le désirez :))
 */
 ...
 * @param FILE* un pointeur vers un fichier ouvert dans lequel il faut écrire le contenu des matrices Q et R
 * 
 * @result le contenu des matrices Q et R a été écrit dans le fichier, suivant le format de l'énoncé
 */
